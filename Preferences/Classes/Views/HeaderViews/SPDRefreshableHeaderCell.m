#import "SPDRefreshableHeaderCell.h"
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)specifier {
    if (self = [super initWithStyle:style reuseIdentifier:nil specifier:specifier]) {
        ...
        [self.actionButton addTarget:specifier.target action:NSSelectorFromString(specifier.properties[@"action"]) forControlEvents:UIControlEventPrimaryActionTriggered];
